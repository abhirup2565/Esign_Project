...
import { MdDashboard ,MdLogin, MdLogout, MdHome ,MdPersonAdd, MdAnalytics } from "react-icons/md";
  ...
  return (
    ...
    <nav className={`Sidebar ${isOpen ? "open" : ""}`}>
      <ul className="Sidebar__container">
        ...
        {user&&(
        <>
        <NavbarLink to="/dashboard" Sidebar__icon={MdDashboard} Sidebar__text="Dashboard" onClick={() => setIsOpen(false)}/>
        {user.is_manager&&(<NavbarLink to="/status" Sidebar__icon={MdAnalytics} Sidebar__text="Status" onClick={() => setIsOpen(false)}/>)}
